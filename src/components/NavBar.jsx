...
//         <li>
//           <NavLink  className="nav_link" to='/category/action'>Action</NavLink>
//         </li>
//         <li>
//           <NavLink className="nav_link" to='/category/rpg' >RPG</NavLink>
//         </li>
//         <li>
...
const pages = [{id:'12', name:'RPG', path:'/category/rpg'},
{id:'12', name:'Action', path:'/category/action'}];
